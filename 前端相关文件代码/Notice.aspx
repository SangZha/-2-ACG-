            ...
            <ul class="message_main_ul">
            	<li class="message_main_list">
                	<div class="main_list_top">
                        <span class="main_list_title">欢迎新用户 o(*≧▽≦)ツ</span>
                    </div>
                    <div class="main_list_bottom">
                        <span class="main_list_content">感谢您的注册，欢迎来到同性恋交友平台（暂称），希望您能喜欢这个网站并多多发布健康向上的文章一起交流分享哦</span>
                        <span class="main_list_time">2016-12-12 23:40:23</span>
                    </div>
                </li>
                <li class="message_main_list">
                	<div class="main_list_top">
